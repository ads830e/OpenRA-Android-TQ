...
namespace OpenRA.Platforms.Default
{
	sealed class Sdl2GraphicsDevice : ThreadAffine, IGraphicsDevice
	{
		...
		public Bitmap TakeScreenshot()
		{
			...
			var bitmap = new Bitmap(rect.Width, rect.Height, System.DrawingCore.Imaging.PixelFormat.Format32bppArgb);
			var data = bitmap.LockBits(rect,
				System.DrawingCore.Imaging.ImageLockMode.WriteOnly, System.DrawingCore.Imaging.PixelFormat.Format32bppArgb);
