...
namespace OpenRA
{
    public static class Game
	{
        ...
        //tq2017
        public static DefaultPlatform dplatform;
		...
		static void Initialize(Arguments args)
		{
			...
			foreach (var p in platforms)
			{
				...
				try
				{
                    ...
                    */
                    dplatform = new DefaultPlatform();

                    var platformType = dplatform.GetType();
                    if (platformType == null)
                        throw new InvalidOperationException("Platform dll must include exactly one IPlatform implementation.");
			...
			if (modID != null && Mods.TryGetValue(modID, out currentMod))
			{
				...
				var launchPath = args.GetValue("Engine.LaunchPath", Platform.GameDir);
